...
/**
 * Represents a retrievable set of game state information which the
 * client can report on.
 */
public enum DataComponent {
    ...
    /**
     * Retrieve positional information for the current player.
     * Game client must be an observer to report this information.
     */
    ...
    /**
     * Retrieve a list of current grenades on the map.
     * Game client must be an observer to report this information.
     */
    GRENADES            ("allgrenades", true),
    
    /**
     * Retrieve the Steam ID of each player on the server.
     * Game client must be an observer to report this information.
     */
    PLAYERS_ID          ("allplayers_id", true),
    
    /**
     * Retrieve the scoreboard statistics for all players on the server.
     * Game client must be an observer to report this information.
     */
    PLAYERS_MATCH_STATS ("allplayers_match_stats", true),
    
    /**
     * Retrieve positional information for all players on the server.
     * Game client must be an observer to report this information.
     */
    PLAYERS_POSITION    ("allplayers_position", true),
    
    /**
     * Retrieve state information for all players on the server.
     * Game client must be an observer to report this information.
     */
    PLAYERS_STATE       ("allplayers_state", true),
    
    /**
     * Retrieve the current weapon loadout for all players on the server.
     * Game client must be an observer to report this information.
     */
    PLAYERS_WEAPONS     ("allplayers_weapons", true),
    
    /**
     * Retrieve state information on the bomb.
     * Game client must be an observer to report this information.
     */
    BOMB                ("bomb", true),
    
    /**
     * Retrieve timing information for the current round phase.
     * Game client must be an observer to report this information.
     */
